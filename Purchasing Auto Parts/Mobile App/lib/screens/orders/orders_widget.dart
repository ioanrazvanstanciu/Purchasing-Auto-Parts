...
import 'package:licenta_app/models/orders_model.dart';
...
class _OrderWidgetState extends State<OrderWidget> {
  ...
  // }
  //'${ordersModel.orderDate.toDate().day}/${ordersModel.orderDate.toDate().month}/${ordersModel.orderDate.toDate().year}'
