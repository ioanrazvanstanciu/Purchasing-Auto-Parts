...
import 'package:licenta_app/models/wishlist_model.dart';
...
class WishlistProvider with ChangeNotifier {
  ...
  Future<void> fetchWishlist() async {
    ...
    final DocumentSnapshot userDoc = await userCollention.doc(user!.uid).get();
    if (userDoc == null) {
      return;
    }
  ...
  Future<void> removeOneItem({
    ...
    final User? user = authInstance.currentUser;
    await userCollention.doc(user!.uid).update({
