...
import 'package:licenta_admin_panel/screens/loading_manager.dart';
import 'package:licenta_admin_panel/controllers/MenuControllerr.dart';
import 'package:licenta_admin_panel/services/global_method.dart';
import 'package:licenta_admin_panel/services/utils.dart';
import 'package:licenta_admin_panel/widgets/buttons.dart';
import 'package:licenta_admin_panel/widgets/header.dart';
import 'package:licenta_admin_panel/widgets/side_menu.dart';
import 'package:licenta_admin_panel/widgets/text_widget.dart';
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TextWidget(text: 'Liter', color: color),
                                        Radio(
                                          value: 1,
                                          groupValue: val,
                                          onChanged: (value) {
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        ...
        items: const [
          ...
          DropdownMenuItem<String>(
            child: Text('Lighting Parts'),
            value: 'Lighting Parts',
          ),
          DropdownMenuItem<String>(
            child: Text('Air Conditioning Parts'),
            value: 'Air Conditioning Parts',
          ),
          DropdownMenuItem<String>(
            child: Text('Power System Parts'),
            value: 'Power System Parts',
          ),
          DropdownMenuItem<String>(
            child: Text('Car Body Parts'),
            value: 'Car Body Parts',
          ),
          DropdownMenuItem<String>(
            child: Text('Wheels and Tires Parts'),
            value: 'Wheels and Tires Parts',
          ),
        ],
        onChanged: (value) {
          setState(() {
